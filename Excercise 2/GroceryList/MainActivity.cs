...
namespace GroceryList
{
	...
	public class MainActivity : Activity
	{
		...
		{
            // Starting an activity by creating an intent, explicitly wrapping
            // the activity inside the intent and passing it to StartActivity
		...
		{
            // Skipping the intent creation altogether and just starting up
            // the activity right in the StartActivity method
